  ...
  <AppLayout>
    <main>
        ...
        <div class="container mx-auto px-12 z-10 grid grid-cols-1 md:grid-cols-12 gap-12 items-center">
          ...
          <div class="md:col-span-6 relative">
            ...
            <div class="absolute -bottom-12 -left-12 aspect-square w-64 bg-primary overflow-hidden rounded-lg shadow-[0_20px_40px_-15px_rgba(27,29,14,0.06)] transform -rotate-3 border-[12px] border-surface">
              <img class="w-full h-full object-cover opacity-90" src="https://lh3.googleusercontent.com/aida-public/AB6AXuA5tAWfmciXKBkJ_P_eEeW_dJ0lOkVbgG-VggXTjpU36EH4FjtsI-gcnvWWI0Q1B1z1oZ1sBgtU3FQMPae8-kfb58-wLWnP03YxuWFYBcG-_GeoMCQZ74q-sHhAUEUlKreWOjNGRldBvKLLaNuyOyToGGDIEJ6qJ8vFPXFYQOpfnjLBHDXMGS8dQzkiW-CnrM5gHSh66uMN3vBXuqFD3Tvf8Yg7mWGZis6P7GnaWfFFveBG3wSrqigEdCoL1RsU8Xg9F6OF_dW_9FoF" alt="Overhead view of sun-drenched vineyards during harvest season with rolling hills and warm golden morning light"/>
            </div>
          </div>
        </div>
      </section>
      ...
      <section class="h-[614px] relative overflow-hidden">
        <img class="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuDSS9Sdznr_JJw2ixxvreypojY_DkH5T4vY0E7LtaCYr4mwJl3yc3sbCisne9GP4o6Nx4ODmXp04Arg2nLChC77I2fNmXn26BHrOxLYs6K_WMwVcx29-Fchzvq6u7q9AAWXtsvEVpJFjwI2zx-lyow6VjP09NHSOO0snbErzRGITnOKOkvb1xhOse2S41xyE1kQI01YBxVfy7JirjNelHTYvFGxTUF0HTteM7PZl2h0obXUFezahs3z7SYDwum0k487425aJQDesmG4" alt="Panoramic view of a grand stone winery architecture at dusk with warm glowing windows and silhouettes of cypress trees"/>
      ...
      <section class="py-32 bg-surface">
        <div class="container mx-auto px-12 grid grid-cols-1 md:grid-cols-2 gap-24 items-center">
          <div class="order-2 md:order-1">
            <div class="relative">
              <div class="aspect-[4/5] bg-surface-container-low rounded-lg overflow-hidden shadow-[0_20px_40px_-15px_rgba(27,29,14,0.06)]">
                <img class="w-full h-full object-cover" src="https://lh3.googleusercontent.com/aida-public/AB6AXuC3r2h7XKPkrrSxHPKSoTGcWQwenUGmS2bug8H8hDelLMf1PVjYb6EXcARFsdl8i-1bLMoaXBBYUqBdhDSR43P7uSZUBDcjBgs8HfJD4MCRNVUyl1XBSqtMddGXu1GqZR-Trcp8cBheZX3kuFa71rozqQ3TtJSl04avpxPudrUbDl-0gtq5OvGCboIgf-o15qm-KaFBacrlNwslhfvdBNz-LUusgRkapyv_xykgu1SQB_PCWrO-NFTUhrkqW0sQQ6hFAiRI5_ICMz4Y" alt="Rows of oak wine barrels in a dim cellar with dramatic lighting highlighting the wood grain and metal hoops"/>
              </div>
          ...
          <div class="order-1 md:order-2">
            ...
            <router-link to="/catalogo" class="mt-12 inline-block px-10 py-5 bg-[#2a0002] text-white font-label text-xs uppercase tracking-[0.2em] rounded-md hover:bg-[#3d0003] transition-all active:scale-95 shadow-lg">
              Ver Productos
            </router-link>
          </div>
        </div>
